...
# upstream   https://github.com/montagneid/ProxmoxVE.git (fetch)
# upstream   https://github.com/montagneid/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/montagneid/ProxmoxVE"
echo ""
