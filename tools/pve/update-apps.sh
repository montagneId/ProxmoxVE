...
source <(curl -fsSL https://raw.githubusercontent.com/montagneid/ProxmoxVE/refs/heads/main/misc/core.func)
...
for container in $CHOICE; do
  ...
  script=$(curl -fsSL https://raw.githubusercontent.com/montagneid/ProxmoxVE/main/ct/${service}.sh)
