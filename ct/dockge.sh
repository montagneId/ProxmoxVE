...
ADDON_SCRIPT="https://raw.githubusercontent.com/montagneid/ProxmoxVE/main/tools/addon/dockge.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/montagneid/ProxmoxVE/main/tools/addon/dockge.sh)"
MIGRATION_EOF
