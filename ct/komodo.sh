...
ADDON_SCRIPT="https://raw.githubusercontent.com/montagneid/ProxmoxVE/main/tools/addon/komodo.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/montagneid/ProxmoxVE/main/tools/addon/komodo.sh)"
MIGRATION_EOF
